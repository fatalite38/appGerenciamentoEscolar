...
## Descrição
Este projeto é um **Sistema de Gerenciamento Escolar** que permite gerenciar informações de alunos e turmas de forma clara e eficiente. O sistema possibilita o cadastro, atualização, listagem e remoção de alunos e turmas, além de calcular a média dos alunos e gerar relatórios completos. Este mesmo foi desenvolvido em grupo como um projeto final do 3º módulo do **Santander Coders**, destacando a colaboração em equipe.
